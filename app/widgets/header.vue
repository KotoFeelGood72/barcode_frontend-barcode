<template>
  <div class="w-full px-9 py-[24px] flex justify-between items-center relative">
    ...
    >
      ...
      <img
        src="/_nuxt/assets/svg/dark/Button.svg"
        alt="Search"
        class="cursor-pointer my-auto w-9 pt-[6px]"
      />
      <div
        class="border-bg-tertiary border-[1px] rounded-[16px] px-[14px] py-3 font-semibold text-sm"
      >
        <h4>1700 <span class="text-text-tertiary">$</span></h4>
      </div>
      <div class="relative">
        <img
          src="/_nuxt/assets/svg/dark/Subtract.svg"
          alt="User"
      ...
      <img
        src="/_nuxt/assets/svg/dark/account.svg"
        alt="Search"
        class="cursor-pointer my-auto w-8 mt-[6px] hidden desktop:block"
      />
      <img
        v-if="!burgerMenuStore.isOpen"
        src="/_nuxt/assets/svg/dark/menu-line-horizontal.svg"
        alt="Search"
      ...
      <img
        v-if="burgerMenuStore.isOpen"
        src="/_nuxt/assets/svg/dark/close.svg"
        alt="Search"
        class="cursor-pointer my-auto w-9 mt-[6px] block desktop:hidden"
        @click="burgerMenuStore.toggle()"
      />
