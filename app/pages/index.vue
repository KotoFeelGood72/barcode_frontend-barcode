<template>
  <div class="flex flex-col gap-4 relative">
    ...
    <img
      src="/_nuxt/assets/svg/dark/home-video.png"
      alt="video"
    ...
    >
      <img
        src="/_nuxt/assets/svg/dark/barcode-mobile.svg"
        alt=""
        class="w-[300px] desktop:hidden tablet:hidden block"
      />
      <img
        src="/_nuxt/assets/svg/dark/barcode-tablet.svg"
        alt=""
        class="desktop:hidden tablet:block hidden"
      />
      <img
        src="/_nuxt/assets/svg/dark/barcode_ai.svg"
        alt=""
    ...
    <div class="flex flex-col px-[76px]">
      <div class="flex justify-between items-center">
        ...
        <div class="flex gap-3">
          <img
            src="/_nuxt/assets/svg/dark/left.svg"
            alt=""
            class="cursor-pointer"
            @click="onClickPrev"
          />
          <img
            src="/_nuxt/assets/svg/dark/right.svg"
            alt=""
