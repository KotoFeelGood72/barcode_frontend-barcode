<template>
  <div class="page py-14">
    <div class="container">
      <div class="grid grid-cols-2 gap-11">
        <div class="flex gap-4 h-[590px] ">
          <Swiper :modules="[Thumbs]" :slides-per-view="6.5" direction="vertical" :space-between="8" :watch-slides-progress="true" :free-mode="true" @swiper="onThumbsSwiper" class="max-h-[590px] max-w-[70px] !mx-0">
          ...
          <Swiper :modules="[Thumbs]" :thumbs="{ swiper: thumbsSwiper }" :breakpoints="breakpoints" class="max-w-[527px] !mx-0">
        ...
        <div class="flex flex-col justify-between">
          <div>     
              <h1 class="lg:text-[28px] mb-2.5">Adobe PRO 2 years</h1>
          ...
          <div class="flex items-center gap-6">
            ...
            <Button text-color="dark" color="white" class="flex-grow">Add to cart</Button>
          </div>
        </div>
      </div>
    </div>
